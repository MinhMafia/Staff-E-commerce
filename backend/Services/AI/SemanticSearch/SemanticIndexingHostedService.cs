...
namespace backend.Services.AI.SemanticSearch
{
    /// <summary>
    /// Tự động index Products khi server khởi động (nếu collection trống)
    /// Comment lại dòng AddHostedService trong Program.cs để tắt tính năng này
    /// </summary>
    public class SemanticIndexingHostedService : IHostedService
    {
        ...
        {
            // Chạy background, không block startup
